...
public class Norme_Gradient implements PlugInFilter {
	...
	public void run(ImageProcessor ip){
		...
		int S = 10; //ICI ON PEUT REGLER LE SEUILLAGE
		int w = ip.getWidth();
		int h = ip.getHeight();
		...
		for (int x = 1; x < w-1; x++){
			for ( int y = 1; y < h-1; y++) {
				...
				int finalRound = (int)Math.round(finalVal);
				...
				/* voici une des possibilités pour pallier au fait que les valeurs ne sont pas comprises entre 0 et 255 : l'ecretage */
				...
				/* derniere méthode possible */
				//finalRound = (finalRound/4);
				...
				*/
				...
				// autre méthode par division par 8 
				/*
